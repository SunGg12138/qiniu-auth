 ...
 * @param {string || object} options.body 可选，当 Content-Type 为 application/x-www-form-urlencoded 时的请求内容，如果是object会被qs.stringify
...
module.exports = function(options){
  let { AccessKey, SecretKey, path, query, body } = options;
  ...
  if (typeof body === 'object') body = qs.stringify(body);
